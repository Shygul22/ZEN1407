...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "An end-to-end platform for leadership, staff and customers.",
      },
    ],
  }),
  component: Landing,
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            <p className="mb-4 inline-flex rounded-full bg-accent px-3 py-1 text-xs font-medium text-accent-foreground">
              Demo mode — every role unlocked
            </p>
            <h1 className="text-5xl font-bold leading-[1.05] tracking-tight md:text-6xl">
              The operating system for your <span className="text-primary">field service</span>{" "}
              business.
            </h1>
            <p className="mt-6 max-w-xl text-lg text-muted-foreground">
              Track jobs, manage enquiries, balance the books and keep customers engaged — from the
              boss's desk to the engineer's hands.
            </p>
          ...
          <div
            className="relative rounded-2xl border bg-card p-6 shadow-2xl"
          ...
          {[
            {
              ...
              desc: "Boss, Admin, Accounts, Service Eng & Sales — each with the right view.",
            },
            {
              icon: Wrench,
              title: "End-to-end workflow",
              desc: "From enquiry to job to service ticket to payment — all linked by CID.",
            },
            {
              icon: Video,
              title: "Customer engagement app",
              desc: "Vertical video feed, service requests, payment history & feedback.",
            },
          ].map((f) => (
