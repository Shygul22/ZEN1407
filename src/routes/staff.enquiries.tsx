...
function EnquiriesPage() {
  ...
  async function updateStatus(id: string, status: string) {
    ...
    if (error) toast.error(error.message); else { toast.success("Enquiry updated"); qc.invalidateQueries({ queryKey: ["enquiries"] }); }
  }
      ...
      <div className="overflow-hidden rounded-xl border bg-card">
        <Table>
          <TableHeader><TableRow>
            <TableHead className="w-[40px]"></TableHead><TableHead>Name</TableHead><TableHead>Contact</TableHead><TableHead>Message</TableHead><TableHead>Status</TableHead><TableHead className="w-[160px]">Update</TableHead>
