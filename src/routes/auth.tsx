      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border bg-card p-6 shadow-xl">
            ...
            <TabsContent value="signup" className="mt-6">
              <form onSubmit={signUp} className="space-y-4">
                ...
                <p className="text-xs text-muted-foreground">
                  New accounts are customer accounts. The boss can promote them to staff later.
                </p>
              </form>
            </TabsContent>
          </Tabs>
          ...
          <div className="mt-6 rounded-lg border border-dashed bg-accent/30 p-3 text-xs text-muted-foreground">
            <strong className="text-foreground">Demo tip:</strong> create any account, then ask the
            boss to grant a staff role from the Staff page. Sign in as <code>boss@volta.demo</code>{" "}
            if seeded, or use the role switcher once you're a super admin.
          </div>
        </div>
      </div>
    </div>
